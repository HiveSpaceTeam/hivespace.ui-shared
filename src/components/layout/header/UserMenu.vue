...
type MenuItem = { href: string; icon: any; textKey: string }
...
const props = defineProps<{
  ...
  avatarSrc?: string
  showSignOut?: boolean
  // Optional signOut function; if not provided we fall back to composable logout
  signOutFn?: (() => Promise<void>) | undefined
}>()
...
// Fallback to composable when caller doesn't provide a `user` or `signOutFn`
